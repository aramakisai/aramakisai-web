...
- [x] 1. スキーマ基盤とルックアップマスタ
- [x] 1.1 構内マップエリア (map_areas) コレクションを定義する
...
- [x] 1.2 タイムスロットマスタ (time_slots) を定義する
...
- [x] 2. 学生団体 (student_exhibitions) コレクション
- [x] 2.1 学生団体コレクションと表示・分類フィールドを定義する
...
- [x] 3. 協賛 (sponsors) コレクション
- [x] 3.1 (P) 協賛コレクションを定義する
...
- [x] 4. タイムテーブル (stages / performance_slots)
- [x] 4.1 ステージ (stages) コレクションを定義する
...
- [x] 4.2 出演枠 (performance_slots) コレクションと二重登録防止を定義する
...
- [x] 4.3 出演枠の必須一方制約をカスタム migration で担保する
...
- [x] 5. お知らせ・固定コンテンツ・祭メタ
- [x] 5.1 (P) お知らせ・トピック・FAQ コレクションを定義する
...
- [x] 6. ロールベースアクセス制御と認証連携
- [x] 6.1 executive ロールを定義する
...
- [x] 6.2 student_exhibitor ロールとフィールド/レコード制限を定義する
...
- [x] 6.3 Authentik OIDC 連携とグループ→ロールマッピングを設定する
