...
import { env } from '@/env';
import { HomePageContent, LiveHomeContent } from '@/lib/home-page-types';
...
describe('Page', () => {
  it('pre_eventの場合、ヒーローとお知らせが表示され、トピックスは表示されない', async () => {
    const preEventContent: HomePageContent = {
      heroImageId: 'hero-1',
  ...
  it('liveの場合、ヒーロー・お知らせ・トピックスが表示される', async () => {
    const liveContent: LiveHomeContent = {
