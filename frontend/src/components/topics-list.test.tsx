...
describe('TopicsList', () => {
  const topics = [
    { id: 1, title: 'Topic 1', body: '<p>Body 1</p>', imageUrl: 'https://example.com/1.jpg', linkUrl: 'https://example.com/link1' },
  ...
  test('renders topics array with images, bodies and links', () => {
    ...
    expect(screen.getByRole('heading', { level: 3, name: 'Topic 1' })).toBeInTheDocument();
    ...
    expect(screen.getByRole('heading', { level: 3, name: 'Topic 2' })).toBeInTheDocument();
